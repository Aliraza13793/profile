"use client"
import React, { SetStateAction, useState,createContext, useContext } from 'react'
...
function ActiveSectionContextProvider({ children }: ActiveSectionContextProviderProps) {
  ...
  const [timeOfLastClick, setTimeOfLastClick]= useState(0); // we need to keep track of this to disablethe observer temporarily when user clicks on link.
  return (
